...
<main class="main" id="top">
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="img/Logo.png" alt="" /></a><button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><i class="fa-solid fa-bars text-white fs-3"></i></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item mt-2 mt-lg-0"><a class="nav-link btn btn-light text-black w-md-25 w-50 w-lg-100" aria-current="page" href="about.html#">Log In</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="pb-0">
        <div class="container">
            <div class="gallery-wraper">
                <div class="img-wraper"><img class="img-fluid" src="img/gallery/1.png" alt="" /></div>
                <div class="img-wraper"><img class="img-fluid" src="img/gallery/2.png" alt="" /></div>
                <div class="img-wraper"><img class="img-fluid" src="img/gallery/3.png" alt="" /></div>
                <div class="img-wraper"><img class="img-fluid" src="img/gallery/4.png" alt="" /></div>
                <div class="img-wraper"><img class="img-fluid" src="img/gallery/5.png" alt="" /></div>
            </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row mt-7">
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="about.html#"><img class="img-fluid" src="img/team/1.png" alt="" /></a>
                    <h1 class="fs-3 mt-3">Michael Scott</h1>
                    <p class="fs-1">General Manager</p>
                </div>
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="about.html#"><img class="img-fluid" src="img/team/2.png" alt="" /></a>
                    <h1 class="fs-3 mt-3">Dwight Schrute</h1>
                    <p class="fs-1">General Manager</p>
                </div>
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="about.html#"><img class="img-fluid" src="img/team/3.png" alt="" /></a>
    ...
    <section class="bg-dark">
        <div class="container">
            <div class="px-xl-8 px-md-5 px-3">
                ...
                <div class="row mt-5">
                    <div class="col-md-3"><img class="img-fluid" src="img/values/1.png" alt="" /></div>
                ...
                <div class="row mt-5">
                    <div class="col-md-3"><img class="img-fluid" src="img/values/2.png" alt="" /></div>
                    <div class="col-md-9 mt-2 mb-md-0">
                ...
                <div class="row mt-5">
                    <div class="col-md-3"><img class="img-fluid" src="img/values/3.png" alt="" /></div>
                    <div class="col-md-9 mt-2 mb-md-0">
...
<section>
    <div class="container bg-dark overflow-hidden rounded-1">
        <div class="bg-holder" style="background-image:url(img/promo/promo-bg.png);"></div>
        <!--/.bg-holder-->
...
<section class="pt-0">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6 col-sm-12"><a href="index.html"><img class="img-fluid mt-5 mb-4" src="img/black-logo.png" alt="" /></a>
            ...
            <div class="col-lg-2 col-sm-4">
                ...
                <ul class="list-unstyled">
                    <li class="my-3 col-md-4"><a href="about.html#">Home</a></li>
                    <li class="my-3"><a href="about.html#">Products</a></li>
                    <li class="my-3"><a href="about.html#">Services</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-sm-4">
                <h3 class="fw-bold fs-1 mt-5 mb-4">Company</h3>
                <ul class="list-unstyled">
                    <li class="my-3"><a href="about.html#">Home</a></li>
                    <li class="my-3"><a href="about.html#">Careers</a><span class="py-1 px-2 rounded-2 bg-success fw-bold text-dark ms-2">Hiring!</span></li>
                    <li class="my-3"><a href="about.html#">Services</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-sm-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-3"><a href="about.html#">Home</a></li>
                    <li class="mb-3"><a href="about.html#">Products</a></li>
                    <li class="mb-3"><a href="about.html#">Services</a></li>
                </ul>
            </div>
        </div>
