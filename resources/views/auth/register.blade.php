                ...
                <form class="needs-validation" novalidate method="post" action="/register">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="password-toggle">
                                <input type="password" id="password-confirm" name="password_confirmation" class="form-control form-control-lg" value="{{old('password_confirmation')}}" required>
                                <label class="password-toggle-btn" aria-label="Show/hide password">
                                    <input class="password-toggle-check" type="checkbox">
                                    <span class="password-toggle-indicator"></span>
                                </label>
                                <div class="invalid-feedback position-absolute start-0 top-100"> Password must match </div>
